...
2. If you have downloaded the data from the provided link, make sure to copy the content of the downloaded folder into the `data` folder inside the repository.
3. Install the required Python packages by running:
    ```bash
    pip install --upgrade pip
    pip install -r requirements.txt
    ```
4. Run the script to process the data and generate the charts:
    ```bash
